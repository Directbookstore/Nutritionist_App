...
if uploaded_file is not None:
    ...
    submit = st.button("Tell me about the food calories")

    if submit:
        with st.spinner("Analyzing the image..."):
            input_prompt = '''
            You are an expert in nutritionist where you need the food items from the image
            ...
            -----
            -----
            Finally, you can also mention whether the food is healthy or not also
